                                ...
                                <ul class="slides">
                                    ...
                                    <li class="slide">
                                        <div class="image_box_bg"> 
                                            ...
                                            <?php } elseif  (@getimagesize($FashionShoplis->shop_image_2 )) { ?>
                                                 <img src="{{$FashionShoplis->shop_image_2}}" alt="" />
                                               
                                            <?php } elseif  (@getimagesize($FashionShoplis->shop_image_3 )) { ?>
                                                 <img src="{{$FashionShoplis->shop_image_3}}" alt="" />
                                            <?php } elseif  (@getimagesize($FashionShoplis->shop_image_4 )) { ?>
                                                 <img src="{{$FashionShoplis->shop_image_4}}" alt="" />
                                            <?php }else{?>
                                            ...
                                            <a href="{{URL::to('Shops/'.base64_encode($FashionShoplis->id).'/ShopDetail')}}">
                                                <div class="overlow_box">
                                                    <div class="overlow_box_content"> 
                                                        ...
                                                        @if(App::getLocale()=="en")  {{$Fdistrictname->name_e}}  @else  {{$Fdistrictname->name_c}}  @endif 
                                                    @endif
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <ul class="slides">
                                    ...
                                    <li class="slide">
                                        <div class="image_box_bg">
                                            ...
                                            <?php } elseif  (@getimagesize($BeautyRetai->shop_image_2 )) { ?>
                                                 <img src="{{$BeautyRetai->shop_image_2}}" alt="" />
                                               
                                            <?php } elseif  (@getimagesize($BeautyRetai->shop_image_3 )) { ?>
                                                 <img src="{{$BeautyRetai->shop_image_3}}" alt="" />
                                              <?php } elseif  (@getimagesize($BeautyRetai->shop_image_4 )) { ?>
                                                 <img src="{{$BeautyRetai->shop_image_4}}" alt="" />
                                            <?php }else{?>
                                                  <img src="{{ asset('images/noimage.png') }}" alt="" />
                                            <?php }?>
                                            </div>
                                ...
                                <ul class="slides">
                                    ...
                                    <li class="slide">
                                        <div class="image_box_bg">
                                            ...
                                            <?php } elseif  (@getimagesize($BeautyServicin->shop_image_2 )) { ?>
                                                 <img src="{{$BeautyServicin->shop_image_2}}" alt="" />
                                               
                                            <?php } elseif  (@getimagesize($BeautyServicin->shop_image_3 )) { ?>
                                                 <img src="{{$BeautyServicin->shop_image_3}}" alt="" />
                                            
                                            <?php } elseif  (@getimagesize($BeautyServicin->shop_image_4)) { ?>
                                                 <img src="{{$BeautyServicin->shop_image_4}}" alt="" />
                                            <?php }else{?>
                                                  <img src="{{ asset('images/noimage.png') }}" alt="" />
                                            <?php }?>
                                            </div>
...
<div class="sign_box" style=" padding:0px; text-align:left">
                    <div class="fb-page" data-href="https://www.facebook.com/FabMap-223293637862783" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false" data-width="225px"></div>
 
                </div>
<div class="join_fabmap_box">

                    <a style="line-height: 6;" href="{{URL::to('Shops')}}"> <h4>{{{ trans('site/site.Tell_about_new_shop') }}} </h4></a>
   ...
   <!--         <div id="fb-root"></div>
            ...
            <div class="signup_join_fabmap">
                <div class="sign_box" style=" padding:10px; text-align:left">
                    <div class="fb-page" data-href="https://www.facebook.com/FabMap-223293637862783" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false" data-width="100%"></div>
