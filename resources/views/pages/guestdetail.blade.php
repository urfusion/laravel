    ...
    <div class="page_content shop_closure form_bg">
        <div class="container">
            ...
            <div class="inner_page_content_bg">
                <form class="form-horizontal" method="post" action="{!! URL::to('/guestinfo') !!}" enctype="multipart/form-data"  autocomplete="off">
                            ...
                            <div class="fild_box_inner">
                                ...
                                <div class="fild select_fild_box">
                                    ...
                                    <select class="" name="user_type"  >
                                        ...
                                        <option class="fabmap_visitor_select" value="1"> {{{ trans('site/site.shop_in_charge') }}} </option>
<!--                                        <option class="fabmap_visitor_select" value="2"> {{{ trans('site/site.fabmap_member') }}}  </option>-->
                                        <option class="fabmap_visitor_select" value="3">{{{ trans('site/site.fabmap_visitor') }}} </option>
...
$(document).ready(function(){
  $('.fabmap_visitor_select').on("click", function(e){
       if ($(this).val() == "1","3") {
