        ...
        <div class="container">
            ...
            <div class="filter_box">
                <div class="filter_left">   {{$data->firstItem()}}  {{{ trans('site/site.to') }}} {{$data->lastItem()}}   {{{ trans('site/site.of') }}}  {{$data->total()}} {{{ trans('site/site.shops') }}} | 
                    <a href="{{URL::to('SearchAllSHopList'.str_replace(URL::current(),'',URL::full()))}}  " >{{{ trans('site/site.View_All_Shop') }}}</a>
                </div>
...
<li><a href="#" data-value="1" data-key="AgeGender" name="age_gender[]" class="closeFilter" >{{{ trans('site/site.Men') }}}</a></li>
@endif
@if(in_array('2', Input::get('age_gender'))) 
<li><a href="#" data-value="2" data-key="AgeGender"  name="age_gender[]"class="closeFilter" >{{{ trans('site/site.Women') }}}</a></li>
@endif
@if(in_array('3', Input::get('age_gender'))) 
<li><a href="#" data-value="3" data-key="AgeGender" name="age_gender[]"class="closeFilter" >{{{ trans('site/site.Infants_Kids') }}}</a></li>
@endif
@endif
            ...
            <div class="refine_search">
                <form action="@if(App::getLocale()=='jp'){{ URL::to('/searchpage_c') }}@else{{ URL::to('/searchpage') }}@endif "  id="searchShopForm" method="get" >
                    ...
                    <div class="refine_left">
                        ...
                        <!--                        Near by-->
                        <div class="cat_box">
                            <h3 id="nearbytogale" style="cursor: pointer;" class="mknear_by">{{{ trans('site/site.Near_by') }}}</h3>
                            ...
                            <div id="nearbytogaleh"  style="display: none;" > 
                                ...
                                <div class="Refine_clear"> 
                                    <input type="submit" name="refine" value="{{{ trans('site/site.Refine') }}}" class="refine_filter">
                                    <a href="javascript:void(0)" onclick="clearFun('nearby');" class="clear_filter">{{{ trans('site/site.Clear') }}}</a>
                                </div>
                            </div>
...
<!--                <a href="#"><img src="{{ asset('images/free_add.png') }}"></a>-->
            ...
            <div class="pagination_shop_bg">
                ...
                <div class="pagination">
                    ...
                    <?php
                    //   include('pagination.shoplist', ['paginator' => $data])
                    //var_dump($data->count()); 
                    ?>
                    <?php //var_dump($data->currentPage()); ?>
                    <?php //var_dump($data->hasMorePages()); ?>
                    <?php // var_dump($data->lastPage()); ?>
                    <?php //var_dump($data->nextPageUrl()); ?>
                    <?php //var_dump($data->perPage()); ?>

                    <?php //var_dump($data->previousPageUrl());  ?>
                    <?php //var_dump( $data->url(1));  ?> 
                    <?php /// echo $data->lastPage(); ?>
                    <?php // var_dump($data->previousPageUrl()); ?>
                </div>
...
//        $(".cat_box h2#nearbytogale").toggleClass("togalclass");
    ...
    $('#nearbytogaleh input[type=checkbox]').change(function () {
        if (this.checked) {
            $('#nearbytogaleh input[type=checkbox]').not(
