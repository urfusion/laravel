...
//     $addressString=str_replace(' ', '',trim($addressString));
 echo preg_replace('/[\s]+/mu', '', $addressString);
      ?>
		...
		<div class="submit_bg">
		 <input type="submit" value="Select all" class="selectall"/>
		 <input type="submit" value="+ Add branches" class="add_branches"/>
		  <input type="submit" value="Sign in" class="add_branches"/>
		</div>
