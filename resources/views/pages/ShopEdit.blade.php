   ...
   <div class="edit_shop_information_list">
    <ul>
	  <li class="update_shop active">
	    <a href="{{URL::to('Shops/updateSearch?Rpage=UpdateInfo')}}">
	  ...
	  <li class="shop_closure">
	    <a href="{{URL::to('Shops/updateSearch?Rpage=ShopClosure')}}">
		<i></i>
	  ...
	  <li class="shop_relocation">
	    <a href="{{URL::to('Shops/updateSearch?Rpage=ShopRelocation')}}">
		<i></i>
	  ...
	  <li class="add_branch">
	    <a href="{{URL::to('Shops/updateSearch?Rpage=AddNewBranch&Rtype=2')}}">
		<i></i>
