...
<div class="col-sm-12">
    ...
    <div class="panel panel-primary  " data-collapsed="0">		 		
        <div class="panel-body">				
            <form autocomplete="off" action="{{ URL::to('admin/forshopupdate/newShop_index') }}" method="post" class="form-horizontal">
...
<!--                <a href="#"  data-href="{{URL::to('admin/forshopupdate/'.base64_encode($Users->id).'/newshopdelete')}}" class="btn btn-danger btn-sm btn-icon icon-left"  data-toggle="modal" data-target="#confirmDelete" data-title="Delete Static Page" data-message="Are you sure you want to delete this Page?" >
                    <i class="entypo-cancel"></i>
                    Delete
                </a>-->

                <a href="{{URL::to('admin/forshopupdate/'.base64_encode($Users->id).'/newshop_detail')}}" class="btn btn-info btn-sm btn-icon icon-left">
...
<div class="dataTables_paginate paging_bootstrap">
    <div style="float: right">
     <?php $Purl='admin/forshopupdate/newShop_index?page='; ?>
    ...
    $(document).ready(function () {
          $('.deleteall').click(function () {
            if ($(".case:checked").length > 0) {
                ...
                $.ajax({
                    url: '{{url()}}/admin/forshopupdate/newShop_index/deleteall',
                    type: "post",
