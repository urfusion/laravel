...
<label class="control-label" for="field-1">
                            ...
                            $priceRangeConfig = explode(',', $Data->shop_type);
                            ?>
                            @endif
                                
                            @if(isset($Data->shop_type)) @if (in_array('1', $priceRangeConfig)) <?php echo "Fashion Shops" . '<br/>' ?> @endif  @endif 
                            @if(isset($Data->shop_type)) @if (in_array('2', $priceRangeConfig)) <?php echo "Beauty Retail Shops" . '<br/>' ?> @endif  @endif 
                            @if(isset($Data->shop_type)) @if (in_array('3', $priceRangeConfig)) <?php echo "Beauty Servicing Shops" . '<br/>' ?> @endif  @endif 
                      </label>
                    </div>
                </div>
    ...
    <div class="clearfix"> 
        ...
        <div class="col-md-5">
            <a  href="{{URL::to('admin/forshopupdate/Branch_index')}}" class="btn btn-sm btn-warning close_popup">
