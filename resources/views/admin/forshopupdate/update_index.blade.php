...
<div class="col-sm-12">
    ...
    <div class="panel panel-primary  " data-collapsed="0">		 		
        <div class="panel-body">				
            <form autocomplete="off" action="{{ URL::to('admin/forshopupdate/update_index') }}" method="post" class="form-horizontal">
...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        ...
        <tr  <?php if($Users->read_status==0){echo 'class="read"'; }else {echo 'class="unread"';} ?> >             
            ...
            <td>
                <a  href="{{URL::to('admin/forshopupdate/'.base64_encode($Users->id).'/update')}}"   class="btn btn-default btn-sm btn-icon icon-left">
                    <i class="entypo-pencil"></i>
                    Update
                </a>
<!--                <a href="#"  data-href="{{URL::to('admin/forshopupdate/'.base64_encode($Users->id).'/delete')}}" class="btn btn-danger btn-sm btn-icon icon-left"  data-toggle="modal" data-target="#confirmDelete" data-title="Delete Shop" data-message="Are you sure you want to delete this shop?" >
    ...
    $(document).ready(function () {
          $('.deleteall').click(function () {
            if ($(".case:checked").length > 0) {
                ...
                $.ajax({
                    url: '{{url()}}/admin/forshopupdate/renovation_index/deleteall',
                    type: "post",
