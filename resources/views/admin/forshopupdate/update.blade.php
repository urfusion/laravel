        ...
        <div data-collapsed="0" class="panel panel-primary col-sm-6">
            ...
            <div class="panel-body">
                ...
                <div class="form-group {{{ $errors->has('chain') ? 'has-error' : '' }}}">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               placeholder="Chain name in engish" type="text"
                               name="chain" id="chain"
                ...
                <div class="form-group {{{ $errors->has('chain_c') ? 'has-error' : '' }}}">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               placeholder="Chain name in chinese" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                            ...
                            <img src="{{{ Input::old('shop_image_1', isset($Data) ?  $Data->shop_image_1 : null) }}}"  width="150"/>
                            @else 
                            No Image
                            @endif
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                            ...
                            <img src="{{{ Input::old('shop_image_2', isset($Data) ?  $Data->shop_image_2 : null) }}}"   width="150"/>
                            @else 
                            No Image
                            @endif
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                            ...
                            <img src="{{{ Input::old('shop_image_3', isset($Data) ?  $Data->shop_image_3 : null) }}}"  width="150" />
                            @else 
                            No Image
                            @endif
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                            ...
                            <img src="{{{ Input::old('shop_image_4', isset($Data) ?  $Data->shop_image_4 : null) }}}"  width="150"/>
                            @else 
                            No Image
                            @endif
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                            ...
                            <img src="{{{ Input::old('shop_image_5', isset($Data) ?  $Data->shop_image_5 : null) }}}"  width="150"/>
                            @else 
                            No Image
                            @endif
                        </div>
