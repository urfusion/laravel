        ...
        <div data-collapsed="0" class="panel panel-primary col-sm-6">
            ...
            <div class="panel-body">
                ...
                <div class="form-group {{{ $errors->has('source') ? 'has-error' : '' }}}">
                    <label class="col-sm-4 control-label" for="field-1">Source of Information</label>

                    <div class="col-sm-5">
                        
                        
                        <label class="control-label" for="field-1">{{{ Input::old('source', isset($Data) ? $Data->source : null) }}}
                ...
                <div class="form-group {{{ $errors->has('contact_phone_1') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <label class="control-label" for="field-1">{{{ Input::old('shop_phone_1', isset($Data) ? $Data->shop_phone_1  : null) }}}
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group {{{ $errors->has('contact_phone_2') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <label class="control-label" for="field-1">{{{ Input::old('shop_phone_2 ', isset($Data) ? $Data->shop_phone_2  : null) }}}
                        </label>
                    </div>
                </div>
                <!------------------Shop Fax------------------------>
...
<!--                <div class="form-group {{{ $errors->has('address') ? 'has-error' : '' }}} ">
                ...
                <div class="form-group {{{ $errors->has('age_gender') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-8">
                        ...
                        <label class="col-sm-12  " for="field-1">  @if(isset($Data->age_gender)) @if (in_array('1', $gender)) <?php echo "Men" ?> @endif  @endif</label>

                        <label class="col-sm-12  " for="field-1">  @if(isset($Data->age_gender)) @if (in_array('2', $gender)) <?php echo "Women" ?> @endif  @endif</label>


                        <label class="col-sm-12  " for="field-1">  @if(isset($Data->age_gender)) @if (in_array('3', $gender)) <?php echo "Infants & Kids" ?> @endif  @endif</label> 
                ...
                <div class="form-group {{{ $errors->has('price_range') ? 'has-error' : '' }}} ">
                    ...
                    @endif
                    <div class="col-sm-8">
                        @if(isset($Data->price_range)) @if (in_array('1', $pricerange)) <label class="col-sm-12  " for="field-1"><$300</label>@endif  @endif
                        @if(isset($Data->price_range)) @if (in_array('2', $pricerange)) <label class="col-sm-12  " for="field-1">$300-$799</label>@endif  @endif
                        @if(isset($Data->price_range)) @if (in_array('3', $pricerange)) <label class="col-sm-12  " for="field-1">$800-$1499</label>@endif  @endif
                        @if(isset($Data->price_range)) @if (in_array('4', $pricerange)) <label class="col-sm-12  " for="field-1">$$1500-$2999</label>@endif  @endif
                        @if(isset($Data->price_range)) @if (in_array('5', $pricerange)) <label class="col-sm-12  " for="field-1">$3000-$4999</label>@endif  @endif
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="field-1">Shop Image 1</label>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="field-1">Shop Image 2</label>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="field-1">Shop Image 3</label>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="field-1">Shop Image 4</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="field-1">Shop Image 5</label>
    ...
    <div data-collapsed="0" class="panel panel-primary col-sm-6">
        ...
        <div class="panel-body">
            ...
            <div class="form-group {{{ $errors->has('facebook') ? 'has-error' : '' }}} ">
                ...
                <div class="col-sm-5">
                    <label class="control-label" for="field-1">  {{{ Input::old('facebook', isset($Data) ?  $Data->facebook : null) }}}</label>
    ...
    <div class="clearfix"> 
        ...
        <div class="col-md-5">
            <a  href="{{URL::to('admin/users/shops_index?page='.$shoppaGeID)}}" class="btn btn-sm btn-warning close_popup">
