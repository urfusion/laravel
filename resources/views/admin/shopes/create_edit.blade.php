...
<div data-collapsed="0" class="panel panel-primary col-sm-9">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            ...
            @if (isset($Data)){{  'Edit Shop' }} @else {{ "Add Shop"}}@endif
        </div> 
    </div>			
    <div class="panel-body">
        ...
        <form class="form-horizontal" method="post"
            ...
            <div class="form-group {{{ $errors->has('name') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-5">
                    <input class="form-control" tabindex="1"
                           ...
                           name="name" id="name"
                           value="{{{ Input::old('name', isset($Data) ? $Data->manager_name : null) }}}">
              ...
              <div class="form-group  ">
                ...
                <div class="col-sm-5">
                    <input class="form-control" tabindex="1"
                           placeholder="{{ trans('admin/users.name') }}" type="text"
                           name="shopename" id="name"
                           value="{{{ Input::old('name', isset($Data)?$Data->shopename:null) }}}">
            ...
            <input class="form-control" tabindex="1" type="hidden" name="role_id" id="role_id" value="5">
            ...
            <div class="form-group"> 
				...
				trans("site/site.cancel") }}
                    ...
                    <button type="submit" class="btn btn-sm btn-success">
                     ...
                     @if (isset($Data))
                    <input class="form-control" tabindex="1" type="hidden" name="user_id" id="user_id" value="{{ base64_encode($Data->sub_user_id) }}">
                    @else
                     <input class="form-control" tabindex="1" type="hidden" name="user_id" id="user_id" value="{{ $id }}">
                     @endif
                </div>
