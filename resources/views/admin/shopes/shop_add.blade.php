...
<!--   <div data-collapsed="0" class="  col-md-12">
                ...
                <div class="form-group {{{ $errors->has('phone') ? 'has-error' : '' }}}">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               value="{{{ Input::old('full_name', isset($User) ?  $User->phone : null) }}}">
                ...
                <div class="form-group {{{ $errors->has('phone_2') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               value="{{{ Input::old('phone', isset($User) ? $User->phone_2 : null) }}}">
  ...
  <!------------------Shop NO------------------------>
                 ...
                 <div class="form-group {{{ $errors->has('mall_c') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               value="{{{ Input::old('mall_c', isset($Data) ? $Data->mall_c : null) }}}">
                 ...
                 <div class="form-group {{{ $errors->has('landmark_c') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               value="{{{ Input::old('landmark_c', isset($Data) ? $Data->landmark_c : null) }}}">
                ...
                <!------------------Shop District------------------------>
               <div class="form-group {{{ $errors->has('distric') ? 'has-error' : '' }}} ">
...
<div class="form-group {{{ $errors->has('display_top') ? 'has-error' : '' }}} ">
                ...
                <div class="col-sm-8" id="display_topcheck">
                    <div class="col-sm-6">
                         <input type="checkbox" name="display_top[]" value="0" class="icheck-2" >

                                   <label   for="field-1">No</label>
                    </div>
                    <div class="col-sm-6">
                        <input type="checkbox" name="display_top[]" value="1" class="icheck-2">
    ...
    <div data-collapsed="0" class="panel panel-primary col-sm-6">
        ...
        <div class="panel-body">
            ...
            <div class="form-group  ">
                ...
                <div class="col-sm-4">
                    <input class="form-control time1" tabindex="1"
                           placeholder="00:00:00" type="text"     name="mondayclosed" id="mondayclosed"
