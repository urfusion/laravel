            ...
            <div class="panel-body">
                ...
                <div class="form-group {{{ $errors->has('phone') ? 'has-error' : '' }}}">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               name="contact_phone_1" id="full_name"
                              
                               value="{{{ Input::old('phone', isset($Data) ?  $Data->contact_phone_1 : null) }}}">
                ...
                <div class="form-group {{{ $errors->has('phone_2') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               placeholder="Contact Number" type="text"
                               name="contact_phone_2" id="phone"
                              
                               value="{{{ Input::old('phone_2', isset($Data) ? $Data->contact_phone_2 : null) }}}">
                ...
                <div class="form-group {{{ $errors->has('email_2') ? 'has-error' : '' }}}">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               value="{{{ Input::old('shop_email', isset($Data) ? $Data->contact_email: null) }}}">
        ...
        <div data-collapsed="0" class="panel panel-primary col-sm-6">
            ...
            <div class="panel-body">
                ...
                <div class="form-group {{{ $errors->has('contact_phone_1') ? 'has-error' : '' }}} ">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               ...
                               name="shop_phone_1" id="contact_phone_1"
                               value="{{{ Input::old('contact_phone_1', isset($Data) ? $Data->shop_phone_1 : null) }}}">
                ...
                <div class="form-group {{{ $errors->has('contact_phone_2') ? 'has-error' : '' }}} ">
                    <label class="col-sm-4 control-label" for="field-1">Shop contact no 2</label>

                    <div class="col-sm-5">
                        <input class="form-control" tabindex="1"
                               placeholder="Shop contact no" type="text"
                               name="shop_phone_2" id="contact_phone_2"
                               value="{{{ Input::old('contact_phone_2', isset($Data) ? $Data->shop_phone_2 : null) }}}">
                        {!! $errors->first('contact_phone_2', '<label class="control-label"
 ...
 <input type="checkbox" value="0" class="icheck-2" name="display_top" @if(isset($Data->display_top)) @if(strpos($Data->display_top, '0') !== false) checked @endif  @endif >
  ...
  <input type="checkbox" value="1" class="icheck-2" name="display_top" @if(isset($Data->display_top)) @if(strpos($Data->display_top, '1') !== false) checked @endif  @endif >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php if (@getimagesize($Data->shop_image_1)) { ?>
                                                <img src="{{$Data->shop_image_1}}" alt="" width="100" height="70" alt="" />
                                            <?php } else { ?>
                                                <img src="{{ asset('images/noimage.png') }}" alt="" width="100" height="70" alt="" />
                                            <?php } ?>
                    </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                                           <?php if (@getimagesize($Data->shop_image_2)) { ?>
                                                <img src="{{$Data->shop_image_2}}" alt="" width="100" height="70" alt="" />
                                            <?php } else { ?>
                                                <img src="{{ asset('images/noimage.png') }}" alt="" width="100" height="70" alt="" />
                                            <?php } ?>
                    </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php if (@getimagesize($Data->shop_image_3)) { ?>
                                                <img src="{{$Data->shop_image_3}}" alt="" width="100" height="70" alt="" />
                                            <?php } else { ?>
                                                <img src="{{ asset('images/noimage.png') }}" alt="" width="100" height="70" alt="" />
                                            <?php } ?>
                    </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php if (@getimagesize($Data->shop_image_4)) { ?>
                                                <img src="{{$Data->shop_image_4}}" alt="" width="100" height="70" alt="" />
                                            <?php } else { ?>
                                                <img src="{{ asset('images/noimage.png') }}" alt="" width="100" height="70" alt="" />
                                            <?php } ?>
                    </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php if (@getimagesize($Data->shop_image_5)) { ?>
                                                <img src="{{$Data->shop_image_5}}" alt="" width="100" height="70" alt="" />
                                            <?php } else { ?>
                                                <img src="{{ asset('images/noimage.png') }}" alt="" width="100" height="70" alt="" />
                                            <?php } ?>
                    </div>
