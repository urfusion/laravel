...
<div data-collapsed="0" class="panel panel-primary col-sm-9">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            ...
            @if (isset($user)){{  'Edit Front User' }} @else {{ "Add Front User"}}@endif
        </div> 
    </div>			
    <div class="panel-body">
      
       <form class="form-horizontal" method="post"
      action="@if (isset($user)){{ URL::to('admin/users/' . base64_encode($user->id) . '/edit') }}@endif"
      autocomplete="off">
			...
			<div class="form-group {{{ $errors->has('phone') ? 'has-error' : '' }}} ">
             ...
             @if(!isset($user))
              ...
              <input class="form-control" tabindex="1" type="hidden" name="role_id" id="role_id" value="3">
