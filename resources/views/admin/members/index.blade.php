...
<div class="col-sm-12">
    ...
    <div class="panel panel-primary  " data-collapsed="0">		 		
        <div class="panel-body">				
            <form autocomplete="off" action="{{ URL::to('admin/members/index') }}" method="post" class="form-horizontal">
...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        ...
        <tr>             
            ...
            <td>{{ preg_replace('/(<.*?>)|(&.*?;)/', '', isset($Users) ?  $Users->name: null)  }}</td>
            <td>{{ preg_replace('/(<.*?>)|(&.*?;)/', '', isset($Users) ? $Users->email : null) }}</td>  
...
<!--                <a  href="{{URL::to('admin/shopowner/'.base64_encode($Users->id).'/update')}}"   class="btn btn-default btn-sm btn-icon icon-left">
                ...
                <a href="{{URL::to('admin/members/'.base64_encode($Users->id).'/detail')}}" class="btn btn-info btn-sm btn-icon icon-left">
    ...
    <div class="col-xs-6 col-right">
        <div class="dataTables_paginate paging_bootstrap">
            <div style="float: right">
                <?php $Purl = 'admin/mebers/index?page='; ?>
