...
<div class="two_fild_row">
    ...
    <div class="fild_box left_fild">
        <div class="fild_box_inner">
            ...
            <div class="fild input_fild_box">
                <input type="text" name="chain" readonly="" required="required" pattern=".*\S+.*[a-zA-z0-9]+"   value="{{{ Input::old('chain', isset($Data) ? $Data->chain : null) }}}"/>
            </div>
        </div>
    </div>
    ...
    <div class="fild_box right_fild">
        <div class="fild_box_inner">
            ...
            <div class="fild input_fild_box">
                <input type="text" name="chain_c" readonly="" required="required"   value="{{{ Input::old('chain_c', isset($Data) ? $Data->chain_c : null) }}}"/>
            </div>
        </div>
    </div>
        ...
        <div class="fild_box_inner">
            ...
            <div class="fild select_fild_box">
                ...
                <select class="" name="regionf" id="regionf"  >
                    <option value="region ">{{{ trans("site/site.Region") }}}</option>
...
<div class="submit_button_bg">
    <i><img src="{{ asset('/images/plus_icon.png') }} "/></i> 
    <input type="submit" value="{{{ trans('site/site.Add_Branch') }}}"/>
</div>
